...
module.exports.deleteProduct = function deleteProduct (req, res, next, prodId, api_key) {
  Producto.deleteProduct(prodId, api_key)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.getProductById = function getProductById (req, res, next, prodId) {
  Producto.getProductById(prodId)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
